...
class Fragment2 : Fragment() {
    ...
    fun setDescription(buttonIndex: Int) {
        ...
        when (buttonIndex) {
            1 -> poasImageView.setImageResource(R.drawable.img)
            2 -> poasImageView.setImageResource(R.drawable.img)
            3 -> poasImageView.setImageResource(R.drawable.img)
        }
    }
